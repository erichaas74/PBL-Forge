...
export const CLASSIC_DRAGON_PARTS: readonly CatalogPresetPart[] = [
  ...
  { definitionId: 'dragon-front-lower-leg', partId: 'classic-dragon-front-left-lower-leg', label: 'Front Left Lower Leg' },
  { definitionId: 'dragon-front-lower-leg', partId: 'classic-dragon-front-right-lower-leg', label: 'Front Right Lower Leg' },
  { definitionId: 'dragon-rear-lower-leg', partId: 'classic-dragon-rear-left-lower-leg', label: 'Rear Left Lower Leg' },
  { definitionId: 'dragon-rear-lower-leg', partId: 'classic-dragon-rear-right-lower-leg', label: 'Rear Right Lower Leg' },
...
export function createClassicDragonTestPreset(
  resolveDefinition: (definition: AssemblyPartDefinition) => AssemblyPartDefinition,
): AssemblyPreset {
  return preset(
...
function buildCatalogPresetAssembly(
  ...
  for (const entry of entries) {
    const definition = resolveDefinition(getDefinition(entry.definitionId));
