...
import { AssemblyViewportComponent } from '../../shared/assembly/assembly-viewport/assembly-viewport.component';
...
@Component({
  ...
  imports: [CommonModule, FormsModule, AssemblyViewportComponent, DragonPortraitComponent],
