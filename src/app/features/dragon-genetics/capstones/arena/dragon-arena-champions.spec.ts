...
import { coreGameteGenome, generateMeiosisRun, } from '../../workstations/dragon-hatchery/meiosis-gamete.domain';
...
describe('arena champion roster', () => {
    it('reconstructs the exact student-bred hatchling from its saved gametes', () => {
        ...
        const expected = fertilizeLabGametes(eggParent, spermParent, coreGameteGenome(eggRun.gametes[1]), coreGameteGenome(spermRun.gametes[2]), 'student-fighter', 1, 'Hatchling 1', 1);
