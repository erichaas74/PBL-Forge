...
import { WISE_DRAGON_CONVERSATION_GATEWAY, WiseDragonConversationGateway, } from './wise-dragon.gateway';
...
describe('WiseDragonSessionStore', () => {
    ...
    it('moves to a provisional summary without writing a canonical grade', async () => {
        ...
        expect(store.summary()).not.toEqual(expect.objectContaining({ grade: expect.anything() }));
    });
});
