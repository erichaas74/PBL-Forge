...
describe('RnaTranslationAnimationComponent', () => {
    ...
    it('gives each residue a distinct side-chain shape and folds the completed chain', () => {
        ...
        const residues = Array.from((fixture.nativeElement as HTMLElement).querySelectorAll<HTMLElement>('.amino-residue'));
    ...
    it('moves through docking, bonding, and translocation phases', () => {
        vi.useFakeTimers();
        component.play();
    ...
    it('animates through the RNA sequence and releases the protein', () => {
        vi.useFakeTimers();
        component.play();
        vi.advanceTimersByTime(560 * 24);
