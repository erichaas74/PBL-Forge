...
describe('parseDragonModelPack', () => {
    ...
    it('requires a connected, single-parent assembly tree', () => {
        ...
        cycleBlueprint.parts.push({ ...cycleBlueprint.parts[0], id: 'cycle-a' }, { ...cycleBlueprint.parts[0], id: 'cycle-b' });
        cycleBlueprint.joints.push(joint('cycle-a-to-b', 'cycle-a', 'cycle-b'), joint('cycle-b-to-a', 'cycle-b', 'cycle-a'));
