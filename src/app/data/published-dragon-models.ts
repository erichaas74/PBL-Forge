...
export function publishedDragonBlueprint(modelId = PUBLISHED_DRAGON_MODEL_PACK.defaultModelId) {
  const model = PUBLISHED_DRAGON_MODEL_PACK.models.find(candidate => candidate.id === modelId);
